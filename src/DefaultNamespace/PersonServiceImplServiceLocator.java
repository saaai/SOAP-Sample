...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SOAP_Sample/services/PersonServiceImpl";
    ...
    public DefaultNamespace.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.PersonServiceImplSoapBindingStub _stub = new DefaultNamespace.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.PersonServiceImplSoapBindingStub _stub = new DefaultNamespace.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "PersonServiceImpl"));
        }
